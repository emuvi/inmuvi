...
class Inmuvi extends qinpel_cps_1.QinStack {
    ...
    step3AdjustTimes(process) {
        ...
        process.detectedFreezes = process.detectedFreezes.filter((freeze) => freeze.freezeEnd - freeze.freezeStart > 1);
        this.step4StripFreezes(process);
    }
    step4StripFreezes(process) {
